...
then
    ...
    if [ -d "/home/coder/project/workspace/angularapp/src/app/components/adminside/user" ]
    then
        cp /home/coder/project/workspace/karma/user.component.spec.ts /home/coder/project/workspace/angularapp/src/app/components/adminside/user/user.component.spec.ts;
    else
        echo "FE_userTest FAILED";
    fi
    ...
    # checking for status component
    if [ -d "/home/coder/project/workspace/angularapp/src/app/components/userside/status" ]
    then
        cp /home/coder/project/workspace/karma/status.component.spec.ts /home/coder/project/workspace/angularapp/src/app/components/userside/status/status.component.spec.ts;
    else
        echo "FE_statusTest FAILED";
    fi 
